...
export function useNoteEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      ...
      /**
       * Intercepte le paste pour détecter les images pures.
       * IMPORTANT : Chrome ajoute toujours image/png même pour du texte copié.
       * On n'intercepte que si le clipboard ne contient PAS de texte (text/html ou text/plain).
       */

              ...
              <div className={focusMode ? 'max-w-[1080px] mx-auto w-full py-8' : 'flex-1 flex flex-col min-h-0'}>
                ...
                <div className="relative">
                  <input
                    ...
                    maxLength={200}
                    className={`w-full px-6 pt-4 pb-1 bg-transparent text-xl font-bold text-white placeholder-gray-600 focus:outline-none ${
                  ...
                  {titleSuggs.length > 0 && (
                    <div
                      className="absolute left-6 top-full z-50 mt-1 bg-dark-800 border border-dark-600 rounded-lg shadow-2xl overflow-hidden min-w-[220px]"
                      onClick={e => e.stopPropagation()}
                    >
                ...
                {slashMenu && (() => {
                  ...
                  return (
                    <div
                      className="absolute left-6 top-16 z-50 bg-dark-800 border border-dark-600 rounded-xl shadow-2xl overflow-hidden w-64"
                      onClick={e => e.stopPropagation()}
                    >
                      ...
                      <p className="px-3 py-1.5 text-[10px] text-gray-600 border-t border-dark-700">
                        ↑↓ · Enter · Esc
                      </p>
                    </div>
                  );
                ...
                {suggestions.length > 0 && (
                  <div
                    className="absolute left-6 bottom-4 z-50 bg-dark-800 border border-dark-600 rounded-lg shadow-2xl overflow-hidden min-w-[160px]"
                    onClick={e => e.stopPropagation()}
                  >
                    <p className="px-3 pt-1.5 pb-0.5 text-[10px] font-semibold text-gray-500 uppercase tracking-wide">Tags</p>

        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1">
            ...
            {showEmptyTrashConfirm && (
              <ConfirmModal
                title="Vider la corbeille ?"
                message={`${deletedNotes.length} note${deletedNotes.length > 1 ? 's' : ''} sera${deletedNotes.length > 1 ? 'ont' : ''} supprimée${deletedNotes.length > 1 ? 's' : ''} définitivement. Cette action est irréversible.`}

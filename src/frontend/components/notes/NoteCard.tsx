      ...
      >
        <button
          ...
          className={`w-full text-left px-3 py-3 border-b border-gray-100 dark:border-dark-800 transition-colors duration-[120ms] ${
            selected ? 'bg-primary-500/10 border-l-2 border-l-primary-400' : 'hover:bg-gray-100/80 dark:hover:bg-dark-650/70'
          }`}
        >
          {/* ── Ligne 1 : épingle + titre ──────────────────────────────────── */}
          <div className="flex items-center gap-1.5 mb-0.5">
            {note.pinned && <Pin size={12} className="text-primary-400 shrink-0" />}

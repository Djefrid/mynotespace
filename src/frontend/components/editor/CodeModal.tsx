...
export default function CodeModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700 rounded-xl shadow-2xl w-[700px] max-w-[95vw] flex flex-col max-h-[80vh]"
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100 dark:border-dark-800 shrink-0">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <select
              ...
              className="text-xs bg-gray-100 dark:bg-dark-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-dark-600 rounded px-2 py-1 focus:outline-none focus:border-yellow-500/50 cursor-pointer"
            >
        ...
        <textarea
          ...
          autoFocus
          spellCheck={false}
          className="code-modal-textarea flex-1 bg-gray-950 dark:bg-dark-950 text-gray-100 dark:text-gray-200 text-sm px-4 py-3 resize-none focus:outline-none min-h-[320px] overflow-y-auto"
        />
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-gray-100 dark:border-dark-800 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={() => setCodeModal(null)}
              className="text-xs px-3 py-1.5 rounded text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-dark-800 transition-colors"
            >
              Annuler
            </button>

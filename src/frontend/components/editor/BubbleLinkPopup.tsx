  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="https://..."
        className="flex-1 text-xs bg-gray-100 dark:bg-[#1a2030] text-gray-800 dark:text-gray-200 placeholder-gray-400 rounded px-2 py-1 focus:outline-none border border-gray-300 dark:border-dark-600 focus:border-yellow-500/50"
      />
      {/* Bouton OK */}
      <button
        type="button"

...
export default function ThemeToggle({ variant = 'icon', className = '' }: ThemeToggleProps) {
  ...
  if (!mounted) {
    ...
    if (variant === 'segmented') return <div className="h-9 w-56 rounded-lg bg-gray-100 dark:bg-[#111520] animate-pulse" />;
  ...
  return (
    <div
      ...
      className={`inline-flex gap-1 p-1 rounded-xl bg-gray-100 dark:bg-[#111520] ${className}`}
    >

    ...
    <AnimatePresence>
      {flyItem && (
        <motion.div
          ...
          className="bg-gray-100 dark:bg-dark-650 border border-primary-500/40 rounded-lg shadow-2xl flex items-center gap-2 px-3 py-1 overflow-hidden"
        >
          <StickyNote size={12} className="text-primary-400 shrink-0" />
